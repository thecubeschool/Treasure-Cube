...
public class TextOutline : MonoBehaviour {
	...
	Vector3 GetOffset(int i) {
		switch (i % 8) {
		case 0: return new Vector3(0, 1, 0.01f);
		case 1: return new Vector3(1, 1, 0.01f);
		case 2: return new Vector3(1, 0, 0.01f);
		case 3: return new Vector3(1, -1, 0.01f);
		case 4: return new Vector3(0, -1, 0.01f);
		case 5: return new Vector3(-1, -1, 0.01f);
		case 6: return new Vector3(-1, 0, 0.01f);
		case 7: return new Vector3(-1, 1, 0.01f);
